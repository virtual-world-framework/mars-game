...
this.onGenerated = function( params, generator, payload ) {
    ...
    this.scene.scenarioSucceeded = this.events.add( this.onScenarioEvent, this );

    // Setup the callbacks that should prevent us from triggering
    this.scene.scenarioStarted = this.events.add( this.reset, this );
...
//@ sourceURL=source/triggers/clauses/clause_OnScenarioSucceeded.js
