...
this.onGenerated = function( params, generator, payload ) {
    ...
    for ( var i = 0; i < blocklyObjects.length; ++i ) {
        ...
        if ( object.blocklyStopped ) {
            object.blocklyStopped = this.events.add( function() { this.onEvent(); }, this );
        } else {
        ...
        if ( object.blocklyErrored ) {
            object.blocklyErrored = this.events.add( function() { this.onEvent(); }, this );
        } else {
    ...
    for ( var i = 0; i < blocklyObjects.length; ++i ) {
        ...
        if ( object.blocklyStarted ) {
            object.blocklyStarted = this.events.add( function() { this.reset(); }, this );
        } else {
...
//@ sourceURL=source/triggers/clauses/clause_OnBlocklyStopped.js
