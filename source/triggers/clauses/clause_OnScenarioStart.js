...
this.onGenerated = function( params, generator, payload ) {
    ...
    this.scene.scenarioStarted = this.events.add( function( scenarioName ) { this.onScenarioEvent( scenarioName ); }, this );
...
//@ sourceURL=source/triggers/clauses/clause_OnScenarioStart.js
